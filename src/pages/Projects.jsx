...
export default function Projects() {
  return <PageShell><SEO title="Projects | Kris Dane Madlambayan" description="Explore web applications and interface projects by Kris Dane Madlambayan, including Thryve, SmartCalc, Recowebdation, AtTheBlanc, and Q-Zone." />
    <section className="project-index-hero"><AmbientField compact /><div className="container"><div className="page-index-mark">03 / 05</div><p className="eyebrow"><span />Project index</p><h1>Work that moves between <em>systems</em> and stories.</h1><div className="project-hero-bottom"><p>A collection of personal, academic, and collaborative web projects—presented honestly and built to strengthen both technical and design practice.</p><span>05 projects / Scroll to inspect</span></div></div></section>
